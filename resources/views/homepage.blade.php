                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div style="row">
                            ...
                            <div class="float-end">
                                <a href="{{ route('usProducts') }}" class="btn"
                                    style="background: #479ad5;color: white;padding: .5rem; border-radius: 10px; text-decoration: none;  margin: 0.5rem 0;">
                            ...
                            <div class="py-2">
                                <a href="{{ route('filters') }}" class="text-decoration-none">
                                    <div class="card" style="border-radius: 25px">
                                        <div class="row">
                                            <div class="col-4">
                                                <img src="images/filtro_reducido.jpg" width="80" height="80"
                                                    class="mx-3 my-2" alt="" style="border-radius: 25px">
                                            </div>
                                            <div class="col-6">
                                                <div class="card-text py-2">
                                                    <h4 class=""
                                                        style="font-size: 1.2em !important; font-weight: 600; color: #333; color: #607d8b;">
                                                        Filtros</h4>
                                                    <h3 class=""
                                                        style="font-size: 1.4em !important;font-weight: 600;color: #333;font-weight: initial !important;">
                                                        Encuentra tu modelo ideal</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="py-1">
                                <a href="{{ route('accesories') }}" class="text-decoration-none">
                                    <div class="card" style="border-radius: 25px">
                                        <div class="row">
                                            <div class="col-4">
                                                <img src="images/mesa_reducido.jpg" width="80" height="80"
                                                    class="mx-3 my-2" alt="" style="border-radius: 25px">
                                            </div>
                                            <div class="col-6">
                                                <div class="card-text py-2">
                            ...
                            <div class="py-2">
                                <a href="{{ route('thermos') }}" class="text-decoration-none">
                                    <div class="card" style="border-radius: 25px">
                                        <div class="row">
                                            <div class="col-4">
                                                <img src="images/termo_reducido.jpg" width="80" height="80"
                                                    class="mx-3 my-2" alt="" style="border-radius: 25px">
                                            </div>
                                            <div class="col-6">
                                                <div class="card-text py-2">
                        ...
                        <div class="py-3">
                            <div class="text-center">
                                <iframe width="100%" height="100%"
                                    src="https://www.youtube.com/embed/uj43MIlYtAo?feature=oembed" frameborder="0"
